...
public class PorcupineModel <T extends SkateboardEntity> extends SinglePartEntityModel<T> {
	private final ModelPart skateboard;
	private final ModelPart head;

	public PorcupineModel(ModelPart root) {
		this.skateboard = root.getChild("skateboard");
        this.head = skateboard.getChild("body").getChild("torso").getChild("head");
    }
	...
	@Override
	public void setAngles(SkateboardEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		this.getPart().traverse().forEach(ModelPart::resetTransform); //resets animation otherwise it would stack on top of each other
	}

	@Override
	public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, float red, float green, float blue, float alpha) {
		skateboard.render(matrices, vertexConsumer, light, overlay, red, green, blue, alpha);
	}
